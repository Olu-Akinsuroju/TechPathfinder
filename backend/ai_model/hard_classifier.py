...
if __name__ == '__main__':
    # Example Usage
    test_phrases = [
        "I love game engines and Unity.",
        "I'm interested in cloud computing with AWS.",
        "My project involves python ml and analyzing datasets.",
        "I want to learn about raspberry pi.",
        "Can I build a smart contract on the blockchain?",
        "She is a specialist in ui design.",
        "He works in cybersecurity, specifically securing systems.",
        "We are training AI models for our startup.",
        "They are developing mobile apps using Swift.",
        "No relevant keywords here.",
        "I use React for building websites.",
        "What about managing servers on GCP?",
        "I'm into AR/VR development.",
        "She mentioned C# for game development."
    ]

    for phrase in test_phrases:
        path = hard_classify(phrase)
        if path:
            print(f"'{phrase}' -> '{path}'")
        else:
    ...
    print(f"'I build games using Unity and custom shaders' -> '{hard_classify('I build games using Unity and custom shaders')}'")
    print(f"'Interested in raspberry Pi projects' -> '{hard_classify('Interested in raspberry Pi projects')}'")
    print(f"'A sentence with no matching keyword' -> '{hard_classify('A sentence with no matching keyword')}'")
